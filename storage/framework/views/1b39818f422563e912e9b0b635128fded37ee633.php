...
<div class="card mb-3">
    ...
    <div style="max-height: 300px;  overflow:hidden">
        <img src="<?php echo e(asset('storage/'. $beranda[0]->image)); ?>" alt="<?php echo e($beranda[0]->category->name); ?> " class="mx-auto d-block" style="max-height:300px;">
    </div>
    <?php else: ?>
    <img src="https://source.unsplash.com/1200x400?<?php echo e($beranda[0]->category->name); ?>" class="card-img-top" alt="<?php echo e($beranda[0]->category->name); ?>"></a>
    <?php endif; ?>
        ...
        <div class="col-md-4 mb-3">
            <div class="card" style="height:18cm">
                <div class="position-absolute px-3 py-2" style="background-color:rgba(0, 0, 0, 0.5)">
                    <a href="/?category=<?php echo e($beranda->category->slug); ?>" class="text-decoration-none text-white"><?php echo e($beranda->category->name); ?></a>
                </div>
                <a href="/beranda/<?php echo e($beranda->slug); ?>">

                    <?php if($beranda->image): ?>
                    <img src="<?php echo e(asset('storage/'. $beranda->image)); ?>" alt="<?php echo e($beranda->category->name); ?>" class="img-fluid">
                    <?php else: ?>
                    <img src="https://source.unsplash.com/500x450?<?php echo e($beranda->category->name); ?>" class="card-img-top" alt="<?php echo e($beranda->category->name); ?>"></a>
                <?php endif; ?>

                <div class="card-body">
                    <h5 class="card-title"><a href="/beranda/<?php echo e($beranda->slug); ?>" class="text-decoration-none text text-dark"><?php echo e($beranda->title); ?></a></h5>
                    <p>
                        <small class="text-muted">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\steva\Desktop\CampOutdoor-main\resources\views/beranda.blade.php ENDPATH**/ ?>